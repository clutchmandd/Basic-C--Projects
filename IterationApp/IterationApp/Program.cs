...
class Program
{
    ...
    {
        //Using a for loop to concatenate a sentence for each string in the list, using the user's input
        ...
        //using the lambda method to display the index that the user's input was found in the list
        ...
        //for loop that displays the index that the user's input was found
        ...
        //foreach loop that evaluates each item in the list, and displays whether or not the item is a duplicate
